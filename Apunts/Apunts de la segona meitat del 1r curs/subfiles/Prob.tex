...
\begin{document}
    ...
    \begin{definicio}[Fórmula de Laplace]
        ...
        \begin{displaymath}
            \mathbb{P}(\mathcal{A}) = \frac{\text{Casos probables a } \mathcal{A} }{\text{Casos possibles}}
        \end{displaymath}
    \end{definicio}
    Una altra manera de calcular la probabilitat és fent servir una visió freqüentista:
    \begin{displaymath}
        \mathbb{P}(\mathcal{A}) = \lim_{n\rightarrow\infty}f_n(\mathcal{A}) \hbox{ on } f_n(\mathcal{A}):= \frac{\text{nombre de cops que hem obtingut } \mathcal{A}}{n}
    \end{displaymath}
