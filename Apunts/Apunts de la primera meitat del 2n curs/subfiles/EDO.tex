...
El polinomic característic de l'equació diferencial serà $P(\lambda) = m\lambda^2 + k = 0$. Llavors, $x(t) = C_1\sin(\sqrt{\frac{k}{m}}t) + C_2\cos(\sqrt{\frac{k}{m}}t) = A\sin(\sqrt{\frac{k}{m}}t + \phi)$.\\
\end{document}
