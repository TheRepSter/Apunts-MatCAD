...
\end{teorema}
\begin{proposicio}[Principi de superposició]
...
\begin{teorema}[Principi de la linearització]
$\;$
\begin{enumerate}
...
\end{definicio}
\begin{teorema}[De Hartman-Grobman]
...
\end{definicio}
\begin{teorema}[de Bendinson-Poincarè]
