...
\begin{document}
	...
	\begin{obs}
		Existeixen doble corbes que si es poden contractar en un punt.
		\begin{center}
			\begin{tikzpicture}
	...
	\begin{definicio}
		Un \underline{quaternion} $q$ és la suma (formal) d'un escalar $q_0 \in \mathbb{R}$ i d'un vector $Q := (q_1, q_2, q_3) \in \mathbb{R}^3$.
